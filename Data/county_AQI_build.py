...
def get_file_names():
    file_list = []
    for filename in os.listdir("C:/Users/User/Documents/Berkeley/data_visualizations/Final Project/Data/EPA AQI - Daily - County"):
        file_list.append("C:/Users/User/Documents/Berkeley/data_visualizations/Final Project/Data/EPA AQI - Daily - County/"+str(filename))
    return file_list
...
with open("C:/Users/User/Documents/Berkeley/data_visualizations/Final Project/Data/EPA AQI - Daily - County/county_AQI.csv", 'wt+') as fout:
